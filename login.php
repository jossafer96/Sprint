...
<body >
 <div class="container">
      ...
      <div id="" class="col-lg-4 col-lg-offset-4">
        <img id="logo-login" class="img img-responsive img-rounded" src="img/logo1.png" />
        <span id="principal-login" class="text-center">Tapices S. De R.L.</span>
      </div>
